"""Auto-generated S&P 500 constituents snapshot (GICS sector + sub-industry).

Source: Wikipedia "List of S&P 500 companies". Symbols normalized for yfinance
(dots -> dashes). Used to auto-pick sector peers. Regenerate by re-running the
fetch in build_sp500.py.
"""
...
SP500 = {
    ...
    'ACGL': ('Financials', 'Property & Casualty Insurance'),
    ...
    'ADM': ('Consumer Staples', 'Agricultural Products & Services'),
    ...
    'AKAM': ('Information Technology', 'Internet Services & Infrastructure'),
    ...
    'AOS': ('Industrials', 'Building Products'),
    ...
    'APTV': ('Consumer Discretionary', 'Automotive Parts & Equipment'),
    'ARE': ('Real Estate', 'Office REITs'),
    'ARES': ('Financials', 'Asset Management & Custody Banks'),
    'ATO': ('Utilities', 'Gas Utilities'),
    'AVB': ('Real Estate', 'Multi-Family Residential REITs'),
    'AVGO': ('Information Technology', 'Semiconductors'),
    'AVY': ('Materials', 'Paper & Plastic Packaging Products & Materials'),
    ...
    'BALL': ('Materials', 'Metal, Glass & Plastic Containers'),
    'BAX': ('Health Care', 'Health Care Equipment'),
    ...
    'BNY': ('Financials', 'Asset Management & Custody Banks'),
    'BR': ('Industrials', 'Data Processing & Outsourced Services'),
    ...
    'CASY': ('Consumer Staples', 'Food Retail'),
    ...
    'CHD': ('Consumer Staples', 'Household Products'),
    ...
    'CLX': ('Consumer Staples', 'Household Products'),
    ...
    'CNC': ('Health Care', 'Managed Health Care'),
    'CNP': ('Utilities', 'Multi-Utilities'),
    'COF': ('Financials', 'Consumer Finance'),
    'COHR': ('Information Technology', 'Electronic Components'),
    ...
    'CPRT': ('Industrials', 'Diversified Support Services'),
    'CPT': ('Real Estate', 'Multi-Family Residential REITs'),
    ...
    'DAL': ('Industrials', 'Passenger Airlines'),
    ...
    'DG': ('Consumer Staples', 'Consumer Staples Merchandise Retail'),
    ...
    'DOV': ('Industrials', 'Industrial Machinery & Supplies & Components'),
    ...
    'DVA': ('Health Care', 'Health Care Services'),
    ...
    'EBAY': ('Consumer Discretionary', 'Broadline Retail'),
    'ECHO': ('Communication Services', 'Wireless Telecommunication Services'),
    'ECL': ('Materials', 'Specialty Chemicals'),
    'ED': ('Utilities', 'Multi-Utilities'),
    'EFX': ('Industrials', 'Research & Consulting Services'),
    ...
    'EVRG': ('Utilities', 'Electric Utilities'),
    'EW': ('Health Care', 'Health Care Equipment'),
    ...
    'FDS': ('Financials', 'Financial Exchanges & Data'),
    'FDX': ('Industrials', 'Air Freight & Logistics'),
    'FDXF': ('Industrials', 'Cargo Ground Transportation'),
    'FE': ('Utilities', 'Electric Utilities'),
    'FFIV': ('Information Technology', 'Communications Equipment'),
    'FICO': ('Information Technology', 'Application Software'),
    'FIS': ('Financials', 'Transaction & Payment Processing Services'),
    'FISV': ('Financials', 'Transaction & Payment Processing Services'),
    'FITB': ('Financials', 'Regional Banks'),
    'FIX': ('Industrials', 'Construction & Engineering'),
    'FLEX': ('Information Technology', 'Electronic Manufacturing Services'),
    'FOX': ('Communication Services', 'Broadcasting'),
    'FOXA': ('Communication Services', 'Broadcasting'),
    'FRT': ('Real Estate', 'Retail REITs'),
    'FSLR': ('Information Technology', 'Semiconductors'),
    'FTNT': ('Information Technology', 'Systems Software'),
    'FTV': ('Industrials', 'Industrial Machinery & Supplies & Components'),
    ...
    'GEN': ('Information Technology', 'Systems Software'),
    ...
    'GNRC': ('Industrials', 'Electrical Components & Equipment'),
    ...
    'GPN': ('Financials', 'Transaction & Payment Processing Services'),
    ...
    'HONA': ('Industrials', 'Aerospace & Defense'),
    'HOOD': ('Financials', 'Investment Banking & Brokerage'),
    'HPE': ('Information Technology', 'Technology Hardware, Storage & Peripherals'),
    'HPQ': ('Information Technology', 'Technology Hardware, Storage & Peripherals'),
    'HRL': ('Consumer Staples', 'Packaged Foods & Meats'),
    'HSIC': ('Health Care', 'Health Care Distributors'),
    'HST': ('Real Estate', 'Hotel & Resort REITs'),
    'HSY': ('Consumer Staples', 'Packaged Foods & Meats'),
    'HUBB': ('Industrials', 'Industrial Machinery & Supplies & Components'),
    ...
    'IEX': ('Industrials', 'Industrial Machinery & Supplies & Components'),
    'IFF': ('Materials', 'Specialty Chemicals'),
    'INCY': ('Health Care', 'Biotechnology'),
    'INTC': ('Information Technology', 'Semiconductors'),
    'INTU': ('Information Technology', 'Application Software'),
    'INVH': ('Real Estate', 'Single-Family Residential REITs'),
    'IP': ('Materials', 'Paper & Plastic Packaging Products & Materials'),
    'IQV': ('Health Care', 'Life Sciences Tools & Services'),
    'IR': ('Industrials', 'Industrial Machinery & Supplies & Components'),
    'IRM': ('Real Estate', 'Other Specialized REITs'),
    ...
    'JBHT': ('Industrials', 'Cargo Ground Transportation'),
    ...
    'KR': ('Consumer Staples', 'Food Retail'),
    'KVUE': ('Consumer Staples', 'Personal Care Products'),
    'L': ('Financials', 'Multi-line Insurance'),
    'LDOS': ('Industrials', 'Diversified Support Services'),
    ...
    'LITE': ('Information Technology', 'Communications Equipment'),
    ...
    'LYB': ('Materials', 'Specialty Chemicals'),
    'LYV': ('Communication Services', 'Movies & Entertainment'),
    ...
    'MKC': ('Consumer Staples', 'Packaged Foods & Meats'),
    ...
    'NDSN': ('Industrials', 'Industrial Machinery & Supplies & Components'),
    ...
    'NWSA': ('Communication Services', 'Publishing'),
    'NXPI': ('Information Technology', 'Semiconductors'),
    'O': ('Real Estate', 'Retail REITs'),
    'ODFL': ('Industrials', 'Cargo Ground Transportation'),
    ...
    'OTIS': ('Industrials', 'Industrial Machinery & Supplies & Components'),
    ...
    'PEG': ('Utilities', 'Electric Utilities'),
    ...
    'PNR': ('Industrials', 'Industrial Machinery & Supplies & Components'),
    ...
    'PSKY': ('Communication Services', 'Movies & Entertainment'),
    'PSX': ('Energy', 'Oil & Gas Refining & Marketing'),
    'PTC': ('Information Technology', 'Application Software'),
    'PWR': ('Industrials', 'Construction & Engineering'),
    'PYPL': ('Financials', 'Transaction & Payment Processing Services'),
    'Q': ('Information Technology', 'Semiconductor Materials & Equipment'),
    ...
    'RJF': ('Financials', 'Investment Banking & Brokerage'),
    ...
    'ROL': ('Industrials', 'Environmental & Facilities Services'),
    'ROP': ('Information Technology', 'Electronic Equipment & Instruments'),
    ...
    'RVTY': ('Health Care', 'Health Care Equipment'),
    ...
    'SNA': ('Industrials', 'Industrial Machinery & Supplies & Components'),
    ...
    'STE': ('Health Care', 'Health Care Equipment'),
    ...
    'SW': ('Materials', 'Paper & Plastic Packaging Products & Materials'),
    ...
    'TAP': ('Consumer Staples', 'Brewers'),
    'TDG': ('Industrials', 'Aerospace & Defense'),
    'TDY': ('Information Technology', 'Electronic Equipment & Instruments'),
    ...
    'TKO': ('Communication Services', 'Movies & Entertainment'),
    ...
    'TRMB': ('Information Technology', 'Application Software'),
    'TROW': ('Financials', 'Asset Management & Custody Banks'),
    'TRV': ('Financials', 'Property & Casualty Insurance'),
    'TSCO': ('Consumer Discretionary', 'Other Specialty Retail'),
    ...
    'UAL': ('Industrials', 'Passenger Airlines'),
    'UBER': ('Industrials', 'Passenger Ground Transportation'),
    'UDR': ('Real Estate', 'Multi-Family Residential REITs'),
    ...
    'VLTO': ('Industrials', 'Environmental & Facilities Services'),
    'VMC': ('Materials', 'Construction Materials'),
    'VRSK': ('Industrials', 'Research & Consulting Services'),
    'VRSN': ('Information Technology', 'Internet Services & Infrastructure'),
    'VRT': ('Industrials', 'Electrical Components & Equipment'),
    ...
    'WAB': ('Industrials', 'Construction Machinery & Heavy Transportation Equipment'),
    ...
    'WSM': ('Consumer Discretionary', 'Homefurnishing Retail'),
    'WST': ('Health Care', 'Health Care Supplies'),
    ...
    'XYL': ('Industrials', 'Industrial Machinery & Supplies & Components'),
    'XYZ': ('Financials', 'Transaction & Payment Processing Services'),
